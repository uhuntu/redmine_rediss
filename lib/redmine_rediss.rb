...
# Libraries
require File.dirname(__FILE__) + '/redmine_rediss/search_data'
require File.dirname(__FILE__) + '/redmine_rediss/rediss_search_service'
...
# Hooks
# Views
require File.dirname(__FILE__) + '/redmine_rediss/hooks/views/base_view_hooks'